...
module.exports.run = async (bot, message, args) => {
    ...
    if(!targetRole) return message.channel.send("*Please specify a new logging channel channel.*");

    guildSett[message.guild.id].GuildSettings.LoggingChannel = targetRole;
