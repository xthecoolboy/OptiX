...
module.exports.run = async (bot, message, args) => {
    ...
    if(!targetRole) return message.channel.send("*Please specify a new Moderator role.*");

    guildSett[message.guild.id].GuildSettings.ModRole = targetRole;
